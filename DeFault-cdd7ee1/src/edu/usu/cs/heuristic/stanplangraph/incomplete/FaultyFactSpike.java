...
public class FaultyFactSpike  extends AbstractFactSpike{

	public FaultyFactSpike(Map<Integer, FactHeader> globalFactHeaders, 
	...
	public FactLevelInfo getFactLevelInfo(int i, Integer index) {
		...
		if(fli == null){
			fli = new FaultyFactLevelInfo(globalFactHeaders.get(index), solver);
