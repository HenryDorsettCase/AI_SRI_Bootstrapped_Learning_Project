...
public class ClassicalActionSpike  extends AbstractActionSpike {

	private static Logger logger = Logger.getLogger(ClassicalActionSpike.class.getName());
	...
	public ClassicalActionSpike(FactSpike factSpike, 
	...
	public ActionLevelInfo getActionLevelInfo(int i, int index) {
		...
		if(ali == null){
			ali = new AbstractActionLevelInfo(globalActionHeaders.get(index), solver);
